...
class ReservaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $datos = Dato::where('status', 'Reserva')
        ...
        return view('admin.Reserva', compact('datos', 'search'));
    }

    // Obtener datos para ver/editar
    ...
    public function update(Request $request, $curp)
    {
        ...
        return redirect()->route('admin.reserva')->with('success', 'Reserva actualizada correctamente.');
    }
}