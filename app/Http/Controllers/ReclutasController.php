...
{
    // Mostrar vista de reclutas
    public function index(Request $request)
    {
        $search = $request->get('search');
        
        $datos = Dato::where('status', 'Recluta')
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.reclutas')->with('success', 'Recluta guardado correctamente.');
    }
    ...
    public function update(Request $request, $curp)
    {
        ...
        return redirect()->route('admin.reclutas')->with('success', 'Recluta actualizado correctamente.');
    }
    ...
    public function destroy($curp)
    {
        ...
        return redirect()->route('admin.reclutas')->with('success', 'Recluta eliminado correctamente.');
    }
}